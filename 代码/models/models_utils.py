...
def get_deep_feedforward_expr_list(print_grid=True, simple_list=True):
    ...
    # """
    # ###########################################################
    # Template for ANNMalware_Model1 ( same for ANNMalware_Model2 but change model_name
    #         {
    #             'model_name': 'ANNMalware_Model1',
    #             'experiment_name': 'ann_experiment_1',
    #             'batch_size': 128,
    #             'image_dim': 256,
    #             'epochs': 10,
    #             'lr': 0.001,
    ...
    #         }
    # ###########################################################
    # Template for CNNMalware_Model3
    #         {
    ...
    #         }
    # ###########################################################
    # Template for CNNMalware_Model4
    #     {
    ...
    #     }
    # ###########################################################
    # Template for CNNMalware_Model5
    #     {
...
def create_deep_image_model(model_params):
    ...
    if model_name == 'CNNMalware_Model3':
        ...
        if image_dim != 0:
            raise Exception("CNNMalware_Model3 needs image_dim = 0")
...
def create_deep_opcode_model(model_params):
    ...
    hidden_dim = 0
    if 'hiddne_dim' in model_params.keys():
    ...
    if model_name == 'CNNMalware_Model5':
        ...
        model = CNNMalware_Model5(input_dim=input_dim, embedding_dim=embedding_dim,
