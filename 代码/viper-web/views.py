...
mod_dict = {'apk': {'help': '-h',
            ...
            'yara': {'scan': 'scan -t',
                     ...
                     'rules': 'rules'},
            'mycmd':{'run': ''},
            'cnn':{'models_structure': '--models_structure',
		   'CNNMalware_Model1':'--CNNMalware_Model1',
		   'My_CNNMalware_Model1':'--My_CNNMalware_Model1',
		   'My_CNNMalware_lenet5':'--My_CNNMalware_lenet5',
